...
const TEMPLATES = [
  ...
  },
  {
    ...
    nombre: 'Sin stock PV',
    plataforma: 'PIM',
    categoria: 'Cancelación / Reembolso',
    estado: 'en revisión',
...
const EXAMPLE_SCENARIOS = [
  ...
  {
    id: 'pedido-estandar-ocasa',
    facetas: ['un-paquete', 'domicilio'],
    logistica: ['ocasa'],
    path: 'examples/vtex/sporting/pedido-estandar-ocasa.sample.json',
    label: 'Pedido estándar - OCASA',
    tipo: 'Pedido',
    descripcion: 'Pedido confirmado con entrega a domicilio por OCASA.',
    compatibleTemplates: ['pedido-confirmado', 'pago-aprobado'],
  },
  {
    id: 'pedido-estandar-retiro',
    facetas: ['un-paquete', 'retiro'],
    logistica: ['retiro'],
    path: 'examples/vtex/sporting/pedido-estandar-retiro.sample.json',
    label: 'Pedido estándar - Retiro en sucursal',
    tipo: 'Pedido',
    descripcion: 'Pedido confirmado con retiro en sucursal (pickup-in-point).',
    compatibleTemplates: ['pedido-confirmado', 'pago-aprobado'],
  },
  {
  ...
  {
    id: 'order-invoiced-andreani',
    facetas: ['un-paquete', 'domicilio'],
    logistica: ['andreani'],
    path: 'examples/vtex/sporting/order-invoiced-andreani.sample.json',
    label: 'Facturación - Andreani',
    tipo: 'Facturación',
    descripcion: 'Pedido facturado con paquete, factura y tracking de Andreani.',
    compatibleTemplates: ['order-invoiced'],
  },
  {
    id: 'order-invoiced-ocasa',
    facetas: ['un-paquete', 'domicilio'],
    logistica: ['ocasa'],
    path: 'examples/vtex/sporting/order-invoiced-ocasa.sample.json',
    label: 'Facturación - OCASA',
    tipo: 'Facturación',
    descripcion: 'Pedido facturado con paquete, factura y tracking de OCASA.',
    compatibleTemplates: ['order-invoiced'],
  },
  {
  ...
  },
  {
    ...
    label: 'Facturación - Producteca · Urbano',
    tipo: 'Facturación',
    descripcion: 'Pedido facturado Producteca con tracking de Urbano (seller adidas).',
    compatibleTemplates: ['order-invoiced'],
  },
  {
...
const EVENT_STAGE_META = {
  ...
  'pedido-facturado': { id: 'facturacion', label: 'Facturación' },
  'factura-disponible': { id: 'facturacion', label: 'Facturación' },
  ...
  'envio-b2b': { id: 'preparacion', label: 'Preparación' },
  'pedido-cancelado': { id: 'cancelacion-reembolso', label: 'Cancelación / Reembolso' },
  'quiebre-stock-pv': { id: 'cancelacion-reembolso', label: 'Cancelación / Reembolso' },
  'quiebre-stock': { id: 'cancelacion-reembolso', label: 'Cancelación / Reembolso' },
  'etiqueta-devolucion': { id: 'cambios-devoluciones-garantia', label: 'Cambios / Devoluciones / Garantía' },
  'recepcion-cambio': { id: 'cambios-devoluciones-garantia', label: 'Cambios / Devoluciones / Garantía' },
  'recepcion-devolucion': { id: 'cambios-devoluciones-garantia', label: 'Cambios / Devoluciones / Garantía' },
  'recepcion-garantia': { id: 'cambios-devoluciones-garantia', label: 'Cambios / Devoluciones / Garantía' },
  'giftcard-enviada': { id: 'cambios-devoluciones-garantia', label: 'Cambios / Devoluciones / Garantía' },
};
...
const VERSION = {
  number: '1.30.8',
  date: '2026-07-27',
  summary: 'Visualizador (etapa 3 de la auditoría): saca los estilos inline dispersos en HTML/JS a clases (.ct-hidden, .ct-vis-clear-btn, etc.) y vacía la tarjeta de info + deshabilita sus acciones cuando el filtro activo deja 0 plantillas, en vez de dejar los datos de la última plantilla válida a la vista.',
};
